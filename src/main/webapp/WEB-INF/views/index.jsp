      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <c:when test="${loginSign eq 'Y' }">
           <li id="userSpan" class="nav-item nav-profile dropdown" >
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <i class="icon-head menu-icon"> User login</i>
            </a>
          ...
          <c:otherwise>
           <li id="userSpan" class="nav-item nav-profile dropdown" >
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <i class="icon-head menu-icon"> Login Please</i>
            </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
...
<!--           <li class="nav-item dropdown">
    ...
    <h6><input id="session" type="hidden" name="session" value="${session}"></h6>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped table-borderless" style="margin-bottom:20px;">
                      <thead>
                        <tr>
                          <th>번호</th>
                          <th>Title</th>
                    ...
                    <div style="display: flex; justify-content: center; align-items: center;">
                                <input id="startPage" type="hidden" value="${paging.startPage}">
								<input id="cntPerPage" type="hidden" value="${paging.cntPerPage}">
								<input id="nowPage" type="hidden" value="${paging.nowPage}">
								<input id="endPage" type="hidden" value="${paging.endPage}">
								<input id="lastPage" type="hidden" value="${paging.lastPage}">
