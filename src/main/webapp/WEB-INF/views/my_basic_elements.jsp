...
<body>
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form id="frm1" class="forms-sample"  method="post">
                   <input type="hidden" name="idx" value="${boardVO.getIdx()}"> 
                    <div class="form-group">
                      <label for="exampleInputName1">Title</label>
                      <input type="text" class="form-control" id="exampleInputName1" placeholder=Title name="title" value="${boardVO.title}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="exampleTextarea1" rows="4" name="content" >${boardVO.content}</textarea>
                          ...
                          <div class="form-check">
                            <label class="form-check-label">
                              <input type="checkbox" class="form-check-input" name="noticeYn" id="noticeYn" value="" checked>
                              공지글 설정
                            </label>
                          </div>
                          <div class="form-check">
                            <label class="form-check-label">
                              <input type="checkbox" class="form-check-input" name="secretYn" id="secretYn" value="" checked>
                              비밀글 설정
                            </label>
                          </div>
                          </form>
                          ...
                          <c:otherwise>
                    		...
                    		<button class="btn btn-light" onclick="Main();">Cancel</button>                          
                          </c:otherwise>
                          </c:choose>                                              
                </div>
              </div>
  ...
  <script src="../../js/select2.js"></script>
	...
	function del(){
		...
		hiddenField.setAttribute('name','sign');
		hiddenField.setAttribute('value','delete');
		form.appendChild(hiddenField);	
		form.submit();
	}
	function update(){
		const title = $('#exampleInputName1').val();
		const writer = $('#exampleInputEmail3').val();
		const content = $('#exampleTextarea1').val();
