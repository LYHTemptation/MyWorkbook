...
public class PaginationInfo {
	...
	public PaginationInfo(PageVO pageBoardVO) {
		if (pageBoardVO.getCurrentPageNo() < 1) {
			pageBoardVO.setCurrentPageNo(1);
		}
		if (pageBoardVO.getRecordsPerPage() < 1 || pageBoardVO.getRecordsPerPage() > 100) {
			pageBoardVO.setRecordsPerPage(10);
		}
		if (pageBoardVO.getPageSize() < 5 || pageBoardVO.getPageSize() > 20) {
			pageBoardVO.setPageSize(10);
		}
