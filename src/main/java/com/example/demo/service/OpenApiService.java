...
public class OpenApiService {
	...
	public String obj(String file) {
		...
		try {
			...
			if (br != null) {
				...
				JSONArray s = (JSONArray) jo.get("predictions");

				JSONObject jo2 = (JSONObject) s.get(0);

				JSONArray ja = (JSONArray) jo2.get("detection_names");
	...
	// Pose Detection
	public String Pose(String file) {
		...
		try {
			...
			if (br != null) {
				...
				JSONObject jo2 = (JSONObject) s.get(0);
				System.out.println("jsonObject " + jo2);

				JSONObject ja = (JSONObject) jo2.get("0");
				System.out.println("jsonObject " + ja);
